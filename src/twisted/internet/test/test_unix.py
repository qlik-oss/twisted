...
class UNIXCreator(EndpointCreator):
    ...
    """
    requiredInterfaces = (
        interfaces.IReactorUNIX,)  # type: Sequence[Type[Interface]]
...
class SocketUNIXMixin(object):
    ...
    """
    requiredInterfaces = (IReactorUNIX,
                          IReactorSocket,)  # type: Sequence[Type[Interface]]
...
class UNIXPortTestsMixin(object):
    requiredInterfaces = (IReactorUNIX,)  # type: Sequence[Type[Interface]]
